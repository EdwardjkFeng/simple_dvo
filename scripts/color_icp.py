...
def main(args):
    ...
    pcd_source = pcd_utils.generate_o3d_pcd(
        img_size, 
        os.path.join(args.datapath, args.startFrameRGB + '.png'), 
        os.path.join(args.datapath, args.startFrameDepth + '.png'), 
        K, False)
    pcd_target = pcd_utils.generate_o3d_pcd(
        img_size,
        os.path.join(args.datapath, args.endFrameRGB + '.png'),
        os.path.join(args.datapath, args.endFrameDepth + '.png'),
        K, False)
    ...
    for scale in range(3):
        ...
        print(result_icp)
    pcd_utils.draw_registration_result_original_color(pcd_source, pcd_target,
